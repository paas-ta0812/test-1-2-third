...
ubuntu@gitbook:~/guide/test-1-2-second/guide-1.0-spaghetti/Development-Guide$ ls
Application_APIPlatform_dorojuso_devlope_guide.md  Buildpack_develope_guide.md  images  OpenPaaS_PaaSTA_Build_Stemcell_guide.md  PublicAPI_devlope_guide.md  README.md  ServicePack_develope_guide.md
ubuntu@gitbook:~/guide/test-1-2-second/guide-1.0-spaghetti/Development-Guide$ cat Buildpack_develope_guide.md
## Table of Contents
1. [문서 개요](#1)
    * [1.1. 목적](#11)
    * [1.2. 범위](#12)
...
[buildpack_develope_guide_01](../images/openpaas-buildpack-devolpe-guide/buildpack_develope_guide_01.png)
[buildpack_develope_guide_02](../images/openpaas-buildpack-devolpe-guide/buildpack_develope_guide_02.png)
ubuntu@gitbook:~/guide/test-1-2-second/guide-1.0-spaghetti/Development-Guide$ vi  Buildpack_develope_guide.md
ubuntu@gitbook:~/guide/test-1-2-second/guide-1.0-spaghetti/Development-Guide$ ls
Application_APIPlatform_dorojuso_devlope_guide.md  Buildpack_develope_guide.md  images  OpenPaaS_PaaSTA_Build_Stemcell_guide.md  PublicAPI_devlope_guide.md  README.md  ServicePack_develope_guide.md
ubuntu@gitbook:~/guide/test-1-2-second/guide-1.0-spaghetti/Development-Guide$ cat Buildpack_develope_guide.md
## Table of Contents
...
[^4]: 루비의 서드파티 라이브러리들을 gem이라하며, RubyGems라는 패키지로 관리할 수 있다.
